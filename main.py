...
class Bambook(App):
    ...
    def build(self):
        ...
        # Words to display
        self.cursor_index = 0
        self.excerpt = "luv u" #Elephants are the largest land animals they eat only plants Even though elephants are very strong, they are the only mammals that cannot jump"
